...
public class CheckoutServiceImpl implements CheckoutService {
    ...
    public CheckoutServiceImpl(UserRepository customerRepository, @Value("${stripe.key.secret}") String secretKey) {
    ...
    public PurchaseResponse placeOrder(Purchase purchase) throws Exception {
        ...
        User customerFromDB = customerRepository.findByEmail(theEmail).orElseThrow(() -> new Exception("User by id " + " was not found"));;
